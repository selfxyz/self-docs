...
{% hint style="info" %}
**On Self Enterprise?** You don't run this verifier, Self verifies on the hot path and sends you a signed webhook. See the [Enterprise quickstart](../../self-enterprise/get-started/quickstart.md).
{% endhint %}
